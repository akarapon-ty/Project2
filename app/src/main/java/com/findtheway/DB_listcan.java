...
public class DB_listcan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCursor = mDb.rawQuery("SELECT " + DBcan.COL_Line + ", "
                + DBcan.COL_Polyline + ", " + DBcan.COL_Level + ","+ DBcan.COL_Polyline +","+ DBcan.COL_PolylineB +","+ DBcan.COL_LevelB +" FROM " + DBcan.TABLE_NAME, null);
        ...
        CustomAdapterbus adapter = new CustomAdapterbus(this,dirArray);
